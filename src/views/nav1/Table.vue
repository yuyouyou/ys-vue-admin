    ...
    <div>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			...
			<div slot="footer" class="dialog-footer">
				...
				<el-button type="primary" @click.native="addEditSubmit" :loading="addLoading" ref="isEdit">提交</el-button>
			</div>
		</el-dialog>
...
import { getUserListPage, batchRemoveUser, removeUser, remove, addEditUser } from '../../api/api';
